...
public class AdminScheduleController {
    ...
    @PostMapping("/assign")
    public ResponseEntity<List<WorkScheduleResponse>> assignSchedule(
            @Valid @RequestBody AssignScheduleRequest request) {
        List<WorkScheduleResponse> schedules = workScheduleService.assignSchedule(request);
    ...
    public ResponseEntity<List<WorkScheduleResponse>> getSchedules(
        ...
        List<WorkScheduleResponse> schedules = workScheduleService.getSchedulesByStaffAndDateRange(
