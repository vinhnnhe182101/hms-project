    ...
    return (
        <footer style={{
            ...
            <Container size="xl">
                <Grid>
                    <Grid.Col span={{ base: 12, md: 3 }}>
                        <Stack gap="md">
                            ...
                            <Text size="md" color="teal.1" style={{ fontSize: '14px' }}>
                    ...
                    <Grid.Col span={{ base: 12, md: 3 }}>
                        <Stack gap="md">
                            ...
                            <Text size="md" color="teal.1" style={{ cursor: 'pointer', fontSize: '14px' }}>
                ...
                <Text size="md" color="teal.2" ta="center" mt={50} style={{ fontSize: '14px' }}>
