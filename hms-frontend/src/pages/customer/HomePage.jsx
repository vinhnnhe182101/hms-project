...
import { Container, Title, Text, Button, Grid, Card, Image, Stack, Box, Group, Overlay, Badge, Avatar, Rating, Divider, Paper } from '@mantine/core';
                    ...
                    {HERO_IMAGES.map((hero, index) => (
                        <Carousel.Slide key={index}>
                            ...
                            >
                                ...
                                <Container size="lg" style={{ position: 'relative', zIndex: 2, textAlign: 'center', color: 'white' }}>
                    ...
                    <Group justify="space-between" align="flex-end" mb={60}>
                        <Box>
                            ...
                            <Text c="dimmed" maw={600} mt="xs">
                                Discover our range of sophisticated accommodations, each designed to provide an unparalleled level of comfort.
                            </Text>
                        </Box>
                        <Button
                            variant="subtle"
                                ...
                                >
                                    <Card.Section style={{ position: 'relative' }}>
                                        ...
                                        <Badge
                                            ...
                                            color="blue"
                                            size="lg"
                                            style={{ backgroundColor: 'rgba(255,255,255,0.9)', color: '#1c7ed6', fontWeight: 700 }}
                                        >
                                    ...
                                    <Stack justify="space-between" mt="xl" style={{ flex: 1 }}>
                                        ...
                                        <Group justify="space-between" align="flex-end" pt="lg">
                                            <Box>
                                                <Text size="xs" c="dimmed" fw={700} style={{ textTransform: 'uppercase' }}>Starting from</Text>
                                                <Text fw={800} color="blue" style={{ fontSize: '24px' }}>
                                                    {formatPrice(room.basePrice)}
                                                    <span style={{ fontSize: '14px', fontWeight: 500, color: '#868e96' }}> / night</span>
                                                </Text>
                                            </Box>
                ...
                <Container size="xl">
                    <Stack align="center" mb={60}>
                        ...
                        <Text ta="center" c="dimmed" maw={650}>
                            From gourmet dining to holistic wellness, we provide a comprehensive suite of services designed around your needs.
                        </Text>
                    </Stack>
                        ...
                        {services.slice(0, 4).map((service, index) => (
                            <Grid.Col key={index} span={{ base: 12, sm: 6, md: 3 }}>
                                ...
                                >
                                    ...
                                    >
                                        <Box style={{ color: 'var(--mantine-color-blue-6)', transition: 'all 0.3s ease' }}>
                                            {getServiceIcon(service.serviceCategory)}
                                        </Box>
                                    </Box>
                                    <Title order={3} fw={700} mb="sm" style={{ fontSize: '20px', transition: 'all 0.3s ease' }}>
                                        {service.name}
                                    </Title>
                    ...
                    <Grid gutter={100} align="center">
                        <Grid.Col span={{ base: 12, md: 5 }}>
                            ...
                            <Text c="dimmed" size="lg" mt="xl" mb="xl">
                                We pride ourselves on delivering excellence. Read about the experiences of our international community.
                            </Text>
                            <Group gap="xl">
                                <Box>
