...
CREATE DATABASE `hms_db` CHARACTER
SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `hms_db`;
-- =========================
-- room_class
-- =========================
CREATE TABLE `room_class`(`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
`extra_person_fee`DECIMAL(
    12,
    2
) NOT NULL DEFAULT 0,
`is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`))ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
-- room
-- =========================
CREATE TABLE `room`(
    ...
    `is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`),
    UNIQUE KEY `uk_room_room_number`(`room_number`),
    KEY `idx_room_room_class_id`(`room_class_id`),
    CONSTRAINT `fk_room_room_class` FOREIGN KEY(`room_class_id`) REFERENCES `room_class`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT
...
CREATE TABLE `user`(
    ...
    `role`VARCHAR(50) NOT NULL COMMENT'User role (suggested): ADMIN | STAFF | MANAGER | CUSTOMER',
...
CREATE TABLE `customer`(
    ...
    `guardian_id` BIGINT UNSIGNEDNULL,
    `user_id` BIGINT UNSIGNEDNULL,
    `is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`),
    KEY `idx_customer_guardian_id`(`guardian_id`),
    KEY `idx_customer_user_id`(`user_id`),
    CONSTRAINT `fk_customer_guardian` FOREIGN KEY(`guardian_id`) REFERENCES `customer`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL CONSTRAINT `fk_customer_user` FOREIGN KEY(`user_id`) REFERENCES `user`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `staff`(
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT UNSIGNEDNULL,
    `department`VARCHAR(100) NULL COMMENT'Department (suggested): HOUSEKEEPING | RECEPTION',
    `full_name`VARCHAR(255) NOT NULL,
    `phone_number`VARCHAR(30)NULL,
...
CREATE TABLE `reservation`(
    ...
    `total_deposit`DECIMAL(
        12,
        2
    ) NOT NULL DEFAULT 0COMMENT'Remaining deposit available for deduction',
...
CREATE TABLE `reservation_room`(
    ...
    `room_class_id` BIGINT UNSIGNED NOT NULL,
    `room_id` BIGINT UNSIGNEDNULL,
    `status`VARCHAR(50) NOT NULL DEFAULT 'PENDING'COMMENT'Allocation status: PENDING | ASSIGNED | CHECKED_IN | CHECKED_OUT | CANCELLED',
    `number_of_people` INT NOT NULL DEFAULT 1COMMENT'Number of people for this allocation',
    `price_at_booking`DECIMAL(
        12,
        2
    ) NOT NULL DEFAULT 0,
    `actual_check_in` DATETIMENULL,
    `actual_check_out` DATETIMENULL,
    `is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`),
    ...
    CONSTRAINT `fk_reservation_room_reservation` FOREIGN KEY(`reservation_id`) REFERENCES `reservation`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_reservation_room_room_class` FOREIGN KEY(`room_class_id`) REFERENCES `room_class`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT CONSTRAINT `fk_reservation_room_room` FOREIGN KEY(`room_id`) REFERENCES `room`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `room_occupant`(
    ...
    CONSTRAINT `fk_room_occupant_reservation_room` FOREIGN KEY(`reservation_room_id`) REFERENCES `reservation_room`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_room_occupant_customer` FOREIGN KEY(`customer_id`) REFERENCES `customer`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
-- service
-- =========================
CREATE TABLE `service`(`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
`name`VARCHAR(255) NOT NULL,
...
ON UPDATE CASCADE
ON DELETE RESTRICT CONSTRAINT `fk_service_booking_reservation_room` FOREIGN KEY(`reservation_room_id`) REFERENCES `reservation_room`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
-- shift
-- =========================
CREATE TABLE `shift`(`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `work_schedule`(
    ...
    CONSTRAINT `fk_work_schedule_staff` FOREIGN KEY(`staff_id`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_work_schedule_shift` FOREIGN KEY(`shift_id`) REFERENCES `shift`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `folio`(
    ...
    CONSTRAINT `fk_folio_reservation_room` FOREIGN KEY(`reservation_room_id`) REFERENCES `reservation_room`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `folio_item`(
    ...
    `service_booking_id` BIGINT UNSIGNEDNULL,
    `description` TEXT NULL,
    `quantity` INT NOT NULL DEFAULT 1,
    `total_price`DECIMAL(
        12,
    ...
    CONSTRAINT `fk_folio_item_folio` FOREIGN KEY(`folio_id`) REFERENCES `folio`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_folio_item_service_booking` FOREIGN KEY(`service_booking_id`) REFERENCES `service_booking`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `payment_transaction`(
    ...
    CONSTRAINT `fk_payment_transaction_folio` FOREIGN KEY(`folio_id`) REFERENCES `folio`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_payment_transaction_handled_by_staff` FOREIGN KEY(`handled_by`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `payment_allocation`(
    ...
    CONSTRAINT `fk_payment_allocation_payment_transaction` FOREIGN KEY(`payment_transaction_id`) REFERENCES `payment_transaction`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_payment_allocation_folio_item` FOREIGN KEY(`folio_item_id`) REFERENCES `folio_item`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `rating`(
    ...
    `is_public` TINYINT(1) NOT NULL DEFAULT 1COMMENT'Public flag: 1=public, 0=private',
    `is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`),
    KEY `idx_rating_reservation_id`(`reservation_id`),
    KEY `idx_rating_customer_id`(`customer_id`),
    CONSTRAINT `fk_rating_reservation` FOREIGN KEY(`reservation_id`) REFERENCES `reservation`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_rating_customer` FOREIGN KEY(`customer_id`) REFERENCES `customer`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
-- asset_category
-- =========================
CREATE TABLE `asset_category`(`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
`name`VARCHAR(255) NOT NULL,
`description` TEXT NULL,
`is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`))ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `room_asset`(
    ...
    CONSTRAINT `fk_room_asset_room` FOREIGN KEY(`room_id`) REFERENCES `room`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_room_asset_asset` FOREIGN KEY(`asset_id`) REFERENCES `asset`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `damage_report`(
    ...
    `reservation_id` BIGINT UNSIGNEDNULL,
    `quantity` INT NOT NULL DEFAULT 1,
    ...
    CONSTRAINT `fk_damage_report_room` FOREIGN KEY(`room_id`) REFERENCES `room`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT CONSTRAINT `fk_damage_report_reservation` FOREIGN KEY(`reservation_id`) REFERENCES `reservation`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL CONSTRAINT `fk_damage_report_staff` FOREIGN KEY(`reported_by_staff_id`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `room_img`(
    ...
    `is_primary`TINYINT(1) NOT NULL DEFAULT 0COMMENT'Primary image flag: 1=yes, 0=no',
    `is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`),
    KEY `idx_room_img_room_class_id`(`room_class_id`),
    CONSTRAINT `fk_room_img_room_class` FOREIGN KEY(`room_class_id`) REFERENCES `room_class`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `housekeeping_task`(
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `room_id` BIGINT UNSIGNED NOT NULL,
    `assignee_id` BIGINT UNSIGNEDNULL,
    ...
    `assigned_at` DATETIMENULL,
    `completed_at` DATETIMENULL,
    `is_active`TINYINT(1) NOT NULL DEFAULT 1COMMENT'Soft delete flag: 1=active, 0=inactive' PRIMARY KEY(`id`),
    KEY `idx_housekeeping_task_room_id`(`room_id`),
    KEY `idx_housekeeping_task_assignee_id`(`assignee_id`),
    CONSTRAINT `fk_housekeeping_task_room` FOREIGN KEY(`room_id`) REFERENCES `room`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_housekeeping_task_assignee` FOREIGN KEY(`assignee_id`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `asset_handover`(
    ...
    CONSTRAINT `fk_asset_handover_staff` FOREIGN KEY(`staff_id`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT CONSTRAINT `fk_asset_handover_asset` FOREIGN KEY(`asset_id`) REFERENCES `asset`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- =========================
...
CREATE TABLE `refund_request`(
    ...
    `status`VARCHAR(50) NOT NULL DEFAULT 'PENDING'COMMENT'Refund request status: PENDING | APPROVED | REJECTED | FAILED',
    `requested_by` BIGINT UNSIGNED NOT NULL,
    `approved_by` BIGINT UNSIGNEDNULL,
    `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
ON UPDATE CURRENT_TIMESTAMP,
    ...
    CONSTRAINT `fk_refund_request_payment_transaction` FOREIGN KEY(`payment_transaction_id`) REFERENCES `payment_transaction`(`id`)
ON UPDATE CASCADE
ON DELETE CASCADE CONSTRAINT `fk_refund_request_requested_by_staff` FOREIGN KEY(`requested_by`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE RESTRICT CONSTRAINT `fk_refund_request_approved_by_staff` FOREIGN KEY(`approved_by`) REFERENCES `staff`(`id`)
ON UPDATE CASCADE
ON DELETE 
SET NULL
)ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
